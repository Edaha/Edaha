...
class DatabaseSchema_mysql extends DatabaseSchema
{
     ...
     */
    public const COMMENT_MAX_TABLE = 60;

    /**
     * Maximum length of a column comment in MySQL.
     */
    public const COMMENT_MAX_COLUMN = 255;
    ...
    protected function createFieldSql($name, $spec)
    {
        ...
        if (in_array($spec['mysql_type'], ['VARCHAR', 'CHAR', 'TINYTEXT', 'MEDIUMTEXT', 'LONGTEXT', 'TEXT']) && isset($spec['length'])) {
            $sql .= '('.$spec['length'].')';
