...
abstract class public_board_base_baseboard extends kxCmd
{
    ...
    {
        $this->board = $this->entityManager->find(Board::class, $this->request['board_id']);
    ...
    public function buildPost($post, $page)
    {
        ...
        // }
        return $this->formatPost($post, $page);
     ...
     * @param bool   $page     Is rendering for a page
     *
     ...
     *
     * @param mixed $post_board
     * @param mixed $post_thread_start_id
     * @param mixed $post_id
     * @param mixed $locale
     */
