...
class Parse
{
    ...
    public function bbcode(&$string)
    {
        ...
        $string = preg_replace_callback('`\[code\](.+?)\[/code\]`is', [&$this, 'codeCallback'], $string);
    }
    ...
    public function clickableQuote(&$buffer)
    {
        ...
        $buffer = preg_replace_callback('/&gt;&gt;&gt;\/([a-zA-Z0-9]+)\/([0-9]+)/', [&$this, 'interboardQuoteCheck'], $buffer);
    }
