...
class manage_board_attachments_filetypes extends kxCmd
{
    ...
    private function _post()
    {
        ...
        if (!isset($this->twigData['notice'])) {
            ...
            $this->twigData['notice']['message'] = ('add' == $this->request['do']) ? _('Filetype added successfully!') : _('Filetype edited successfully!');
            $log_message = ('add' == $this->request['do']) ? _('Added filetype %s') : _('Edited filetype %s');
            logging::addLogEntry(
