...
class SelectQueryExtender implements SelectQueryInterface
{
    ...
    {
        return call_user_func_array([$this->query, 'hasAnyTags'], func_get_args());
    }
    ...
    {
        return $this->condition->compile($connection, $queryPlaceholder ?? $this);
    }
    ...
    public function extend($extender_name)
    {
        ...
        $class = $this->connection->getDriverClass($extender_name, [], true);
...
class SelectQuery extends Query implements SelectQueryInterface
{
    ...
    public function __construct($table, $alias = null, ?kxDB $connection = null, $options = [])
    {
    ...
    public function compile(kxDB $connection, ?QueryPlaceholderInterface $queryPlaceholder = null)
    {
        return $this->where->compile($connection, $queryPlaceholder ?? $this);
    }
    ...
    public function range($start = null, $length = null)
    {
        $this->range = func_num_args() ? ['start' => $start, 'length' => $length] : [];
