...
/* manage/rules.tpl */
class __TwigTemplate_abd98cf046975743f7741f4d953c41c4 extends Twig_Template
{
    protected $parent;
...
<table class=\"users\" cellspacing=\"1px\">
  ...
  ";
      ...
      <td>";
            // line 35
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context['rules']) ? $context['rules'] : null), "entry_order", array(), "any", false, 35), "html");
            echo "</td>
      <td>";
            // line 36
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context['rules']) ? $context['rules'] : null), "entry_subject", array(), "any", false, 36), "html");
            echo "</td>
      <td>";
            // line 37
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context['rules']) ? $context['rules'] : null), "entry_message", array(), "any", false, 37), "html");
            echo "</td>
      <td>[ <a href=\"";
            // line 38
            echo twig_escape_filter($this->env, (isset($context['base_url']) ? $context['base_url'] : null), "html");
            echo "app=core&amp;module=site&amp;section=front&amp;do=rules&amp;action=edit&amp;id=";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context['rules']) ? $context['rules'] : null), "entry_id", array(), "any", false, 38), "html");
            echo "\">";
            echo _gettext("Edit");            echo "</a> ] [ <a href=\"";
            echo twig_escape_filter($this->env, (isset($context['base_url']) ? $context['base_url'] : null), "html");
            echo "app=core&amp;module=site&amp;section=front&amp;do=rules&amp;action=del&amp;id=";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context['rules']) ? $context['rules'] : null), "entry_id", array(), "any", false, 38), "html");
            echo "\">";
