...
abstract class kxDB
{
     ...
     */
    public const RETURN_NULL = 0;

    /**
     * Flag to indicate a query call should return the prepared statement.
     */
    public const RETURN_STATEMENT = 1;

    /**
     * Flag to indicate a query call should return the number of affected rows.
     */
    public const RETURN_AFFECTED = 2;

    /**
     * Flag to indicate a query call should return the "last insert id".
     */
    public const RETURN_INSERT_ID = 3;
    ...
    {
        $class = $this->getDriverClass('SelectQuery', ['query.php', 'select.php']);
    ...
    {
        $class = $this->getDriverClass('InsertQuery', ['query.php']);
    ...
    {
        $class = $this->getDriverClass('MergeQuery', ['query.php']);
    ...
    {
        $class = $this->getDriverClass('UpdateQuery', ['query.php']);
    ...
    {
        $class = $this->getDriverClass('DeleteQuery', ['query.php']);
    ...
    {
        $class = $this->getDriverClass('TruncateQuery', ['query.php']);
    ...
    public function schema()
    {
        if (empty($this->schema)) {
            $class = $this->getDriverClass('DatabaseSchema', ['schema.php']);
     ...
     */
    final public static function loadDriverFile($driver, array $files = [])
    {
        static $base_path;
    ...
    {
        if (!self::$instance instanceof kxDB) {
            self::initialize();
        }
...
class kxDBStatementBase extends PDOStatement implements kxDBStatementInterface
{
    ...
    public function execute($args = [], $options = []): bool
    {
