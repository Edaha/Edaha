...
class manage_core_site_embeds extends kxCmd
{
    ...
    {
        if ('edit' == $this->request['action'] && !empty($this->request['embed_id'])) {
    ...
    {
        if ('delete' == $this->request['action'] && !empty($this->request['embed_id'])) {
        ...
        if ('add' == $this->request['action'] && !empty($this->request['embed_id'])) {
            ...
            logging::addLogEntry(
                ...
                sprintf('Updated embed %s', $this->request['embed_name']),
                __CLASS__
            );
        } elseif ('add' == $this->request['action']) {
            ...
            logging::addLogEntry(
                kxFunc::getManageUser()['user_name'],
                sprintf('Created embed %s', $this->request['embed_name']),
                __CLASS__
            );
        }
        $this->_show();
