...
class getid3_id3v2
{
	...
	public function ParseID3v2Frame(&$parsedFrame, &$ThisFileInfo) {
	...
	public function LanguageLookup($languagecode, $casesensitive=false) {
	...
	public function ETCOEventLookup($index) {
	...
	public function SYTLContentTypeLookup($index) {
	...
	public function APICPictureTypeLookup($index, $returnarray=false) {
	...
	public function COMRReceivedAsLookup($index) {
	...
	public function RVA2ChannelTypeLookup($index) {
	...
	public function FrameNameLongLookup($framename) {
	...
	public function FrameNameShortLookup($framename) {
	...
	public function TextEncodingTerminatorLookup($encoding) {
		// http://www.id3.org/id3v2.4.0-structure.txt
	...
	public function TextEncodingNameLookup($encoding) {
		// http://www.id3.org/id3v2.4.0-structure.txt
		static $TextEncodingNameLookup = array(0=>'ISO-8859-1', 1=>'UTF-16', 2=>'UTF-16BE', 3=>'UTF-8', 255=>'UTF-16BE');
		return (isset($TextEncodingNameLookup[$encoding]) ? $TextEncodingNameLookup[$encoding] : 'ISO-8859-1');
	}

	public function IsValidID3v2FrameName($framename, $id3v2majorversion) {
	...
	public function IsANumber($numberstring, $allowdecimal=false, $allownegative=false) {
	...
	public function IsValidDateStampString($datestamp) {
	...
	public function ID3v2HeaderLength($majorversion) {
